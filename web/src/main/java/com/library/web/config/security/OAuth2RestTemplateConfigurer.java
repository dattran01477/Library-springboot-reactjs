...
import com.library.web.config.security.OAuth2RestTemplateConfigurer.ServiceAccountEnabled;

/**
 * OAuth2RestTemplateConfigurer is to create a bean of type
 * {@link OAuth2RestTemplate}.
 * <p>
 * This configurer is run only when following properties are set in
